...
<CardGroup cols={2}>
  <Card title="Order Lifecycle" icon="arrows-rotate" href="/event-contracts/untitled-page-7">
    Follow an order from submission through matching and settlement.
  </Card>

  <Card title="Positions & Tokens" icon="coins" href="/event-contracts/untitled-page-8">
