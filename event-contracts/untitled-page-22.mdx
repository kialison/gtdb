---
title: "How Positions Work: CTF Tokens and Redemption"
...
Event market tokenizes market outcomes using the [Conditional Token Framework (CTF)](https://docs.gnosis.io/conditionaltokens/), an open standard developed by Gnosis. Understanding CTF explains how positions are created, combined, and redeemed onchain.
...
<Steps>
  ...
  <Step title="Execute the Redemption">
    ...
    See [Execute Gasless Transactions](/event-contracts/untitled-page-18) for nonce creation, wallet-batch signing, and confirmation. Wait for `STATE_CONFIRMED` before using the payout.
  </Step>
</Steps>
