...
<CardGroup cols={2}>
  <Card title="Positions & Tokens" icon="coins" href="/event-contracts/untitled-page-7">
    Learn how to redeem winning tokens after resolution.
  </Card>

  <Card title="Markets & Events" icon="chart-line" href="/event-contracts/untitled-page-4">
