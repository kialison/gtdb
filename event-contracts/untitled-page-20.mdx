...
See [Order Statuses](/event-contracts/untitled-page-9) to interpret the returned `status`.
...
See [Order Statuses](/event-contracts/untitled-page-9) to interpret each order's `status`.
...
See [Trade Statuses](/event-contracts/untitled-page-9) to follow each trade's `status` through settlement.
...
See [Builder Programs](/event-contracts/untitled-page-3) to learn how attribution works.
