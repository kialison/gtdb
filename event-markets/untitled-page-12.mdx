...
The market object represents a event market. Alongside its question and outcomes, it describes the market's current state and provides the information an integration needs to read prices, follow activity, or trade.

The examples below assume you already have a market object. To find or fetch one, see [Discover Markets](/event-markets/untitled-page-11).
...
| `negRisk` | boolean | Market belongs to a [negative-risk group](/event-markets/untitled-page-6). |
...
See [Augmented Negative Risk](/event-markets/untitled-page-6) for how named outcomes, placeholders, and Other behave.
...
See [Place Orders](/event-markets/untitled-page-19) for the implications of trading on a market with a configured delay.
