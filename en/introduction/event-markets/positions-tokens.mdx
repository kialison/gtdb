...
description: "Understand outcome tokens, how positions work on event markets, position value, and how profit and loss is calculated."
---

Every contract on event markets is represented by outcome tokens. When you trade, you're buying and selling these tokens. Your position is simply your balance of tokens for a given market.
