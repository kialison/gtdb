...
Event Contracts uses the UMA Optimistic Oracle for decentralized, permissionless resolution. Anyone can propose an outcome, and anyone can dispute it if they believe it's incorrect.
...
<Steps>
  <Step title="Proposal">
    ...
    2. Posting a bond (typically \$750 USDT)
...
After resolution, redeem through the CTF collateral adapter to exchange winning tokens for USDT. The adapter burns your ERC1155 outcome tokens through the CTF contract, receives the released USDC.e collateral, wraps it into USDT, and returns USDT to your wallet.
...
<CardGroup cols={2}>
  <Card title="Positions & Tokens" icon="coins" href="/event-contracts/positions-tokens">
    Learn how to redeem winning tokens after resolution.
  </Card>

  <Card title="Markets & Events" icon="chart-line" href="/event-contracts/markets-events">
