...
Event Contracts use a Central Limit Order Book (CLOB) for trading. Prices aren't set by the platform, they emerge from supply and demand as users trade with each other.
...
Every share on Event Contracts is priced between \$0.00 and \$1.00. The price directly represents the market's belief in the probability of that outcome.
...
<CardGroup cols={2}>
  <Card title="Order Lifecycle" icon="arrows-rotate" href="/event-contracts/order-lifecycle">
